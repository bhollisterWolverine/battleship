...
public class battleShip {
    ...
    public static void main(String[] args) {
        ...
        do{
        	bs.showBoard(bs.board);
        	bs.shoot(bs.shoot);
        	
            if(bs.hit(bs.shoot,bs.ships)){
            	bs.hint(bs.shoot,bs.ships,bs.attempts);
            	
            }                
            else
            	bs.hint(bs.shoot,bs.ships,bs.attempts);
            
            bs.changeboard(bs.shoot,bs.ships,bs.board);
            

        }while(bs.shotHit!=3);
        
        System.out.println("\n\n\nBattleship Java game finished! You hit 3 ships in "+bs.attempts+" attempts");
        bs.showBoard(bs.board);
    }
